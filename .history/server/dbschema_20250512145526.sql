...
('Liberal Arts Building', 'liberal-arts-building'),
('Hawkins Hall', 'hawkins-hall'),
...
CREATE TABLE IF NOT EXISTS items (
    ...
    location_lost VARCHAR(100) NOT NULL,         -- From dropdown OR customLocation
    custom_location VARCHAR(100),                -- Only if "Other" selected
