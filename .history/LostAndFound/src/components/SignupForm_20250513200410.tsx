  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response (non-JSON). Please try again.");
      }
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-sm text-gray-600">
        ...
        <a href="/login" className="text-yellow-600 hover:text-yellow-500 ml-1">
          Sign in
        </a>
      </p>
    </form>
