 ...
 * Nav Component
 * -------------
 * Renders the main navigation menu for authenticated users.
 * - Displays links to feed, report pages, buildings dropdown, and contact page.
 * - Checks login status from local/session storage on mount.
 */
