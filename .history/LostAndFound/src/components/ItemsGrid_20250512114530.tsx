 ...
 * ItemsGrid Component
 * -------------------
 * Renders a responsive grid of ItemCards based on active tab ("lost" or "found").
 * - Receives filtered lost and found items as props.
 * - Displays a fallback message if no items match.
 * - Wraps each ItemCard in a constrained-width container.
 */
