...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-20 w-full border-b-2 border-b-[#cc9900] bg-black px-8 py-4 capitalize text-white">
      <div className="container flex h-12 items-center justify-between space-x-10">
