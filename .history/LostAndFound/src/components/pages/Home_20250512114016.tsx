 ...
 * Home Component
 * --------------
 * Landing page of the TU Lost and Found site.
 * - Displays a full-screen background video showcasing Towson campus life.
 * - Renders the main title with styled highlight on "Lost" and "Found".
 * - Includes a tab switcher (e.g., for toggling lost/found items below the fold).
 */
